        ...
        headerActions={
          <>
            <div className="relative">
              ...
              {pickerOpen && (
                <div className="absolute top-8 right-0 z-50 max-h-80 w-72 overflow-y-auto rounded-lg border border-border bg-card p-1 shadow-lg">
                  {isLoading && (
